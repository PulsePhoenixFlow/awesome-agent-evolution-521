...
```bash
git clone https://github.com/PulsePhoenixFlow/awesome-agent-evolution-521.git
cd awesome-agent-evolution-521
python setup.py
```
...
|---|---|---|---|
| [desplega-ai/agent-swarm](https://github.com/PulsePhoenixFlow/awesome-agent-evolution-521) | production lead-worker swarm runtime | 它把 agent-swarm 从“多角色编排”推进到带 Docker worker、persistent identity、compounding memory 和 HITL gate 的生产执行面。 | [KNOWN] GitHub source-scoped；未做独立生产审计。 |
...
<!-- Last updated: 2026-06-06 19:53:58 -->
